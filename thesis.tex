...
\subsection{Parallel Rendering Modes}
...
rendering code to access the correct data, and synchronizing execution. When
multiple GPUs are used to accelerate the rendering of a single output, partial
results need to be collected from all contributing resources and combined on the
output.

\subsection{Rendering Context}
...
\section{New Parallel Rendering Modes}
