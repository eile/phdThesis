...
often in isolation to each other, e.g., algorithms and implementations for Cave
...
mode provides close to perfect load balance.
...
\fig{fStereo} shows an ana-gly-phic stereo compound.
...
\begin{wrapfloat}{figure}{O}{.618\textwidth}
\includegraphics[width=.618\textwidth]{images/DBStream}
{\caption{\label{fDBStream}Streaming Sort-Last Compound}}
\end{wrapfloat}
...
\begin{wrapfloat}{figure}{I}{.382\textwidth}
\includegraphics[width=.382\textwidth]{images/DBStreamFlow}
{\caption{\label{fDBStreamFlow}Streaming Sort-Last Data Flow}}
\end{wrapfloat}
...
\fig{fDBStreamFlow}. This pipelining emerges naturally due to the
...
through simplified configuration, monitoring and administration tools.
...
an application. Furthermore, implementing load balancing to the compositing
task is an area largely unexplored, in particular in combination with the state
