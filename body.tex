...
with up to 12 source GPUs. \bench{rCSLBFPS} shows an overview for the achievable
...
\bench{rCSLB} shows the rendering time over a fixed camera path rendering 540
...
\section{Monitoring}
\begin{wrapfloat}{figure}{R}{.382\textwidth}
