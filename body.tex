...
\cite{EMP:09} and \cite{ESP:18} publish the architectural contributions for
this thesis. Any algorithmic and architectural contributions in these
publications are contributed by the author, while experimental results have
significant contributions from the secondary authors.
