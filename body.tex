...
to perfect load balance. \fig{fStereo} shows an anaglyphic stereo compound.
...
Time-multiplexing (\fig{fDPlex}), also called AFR or DPlex, was first
...
\begin{figure}[ht]\center
  ...
  \caption{Synchronous readback and upload (a) readback as well as
...
\section{Download and Compression Plugins}
