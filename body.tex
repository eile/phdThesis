...
reality the load is not uniformly distributed, it tends to increase
...
grid as shown in \fig{fROI}, top. In cases where the rendered data projects only
...
CSLB uses a two-stage approach, where a {\em view\_equalizer} at the top level of the
...
rendering load. One physical GPU assigned to a source channel can be
