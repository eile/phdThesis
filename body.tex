...
Many resources entities described in \cref{sArchitecture} are distributed
...
Different implementations of a connection exists. A connection transmits a raw
...
connection set is used to select one connection which requires some action.
...
object data. We test the time to commit and sync the data using the compression
